...
| 聊天智能体的桌面控制、确认、回执/撤回、快捷对话 | [伴侣智能体桌面控制设计](../../doc/伴侣智能体桌面控制设计.md) + 经验 L15 + companion-agent 测试 |
...
| [伴侣智能体桌面控制设计](../../doc/伴侣智能体桌面控制设计.md) | 2026-09-26 按源码描述已实现的工具常驻、确认策略、回执/撤回和快捷对话；继承桌面编排设计的风险分级，桌面编排设计 §8 的工具清单以此处和源码注册表为准 |
