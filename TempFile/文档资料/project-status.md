...
> 源码、隔离验证与最近本机安装验证：2026-09-05。
> 1.1.12 已包含 09-05 修复与紧凑显示工具栏，Windows 安装包与本机覆盖安装均已验证；本机实际运行 1.1.12，用户数据已备份并核验保留。尚未上传该版本 GitHub Release。
...
| 发行 | [1.1.12](../../doc/发布说明/1.1.12.md) 安装包、本机覆盖安装及启动验证完成 | 未发布该版本远端资产；未配置 Windows 代码签名证书 |
