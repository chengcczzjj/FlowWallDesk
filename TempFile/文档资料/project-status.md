...
| 正式分发         | ✅ v1.1.8 | ToDesk 远程控制前台闪烁修复版已生成 Windows NSIS 安装包、完成本机覆盖安装，并发布 GitHub Release 及自动更新资产 |
...
| 双显示器设置   | ✅ 完成 | 主屏/复制/按屏设置/跨屏延展四种模式；普通多屏使用每台显示器独立原生壁纸窗口，支持可视化拓扑、热插拔和壁纸库直接指定屏幕 |
